...
CallbackReturn BTExecutor::on_cleanup(const rclcpp_lifecycle::State& /*state*/)
{
  RCLCPP_INFO(logger_, "Cleaning up.");
  return CallbackReturn::SUCCESS;
}

CallbackReturn BTExecutor::on_shutdown(const rclcpp_lifecycle::State& /*state*/)
{
...
BT::Blackboard::Ptr BTExecutor::setup_blackboard()
{
  ...
  blackboard->set(
    "default_cancel_timeout", get_parameter("default_cancel_timeout").as_double());
