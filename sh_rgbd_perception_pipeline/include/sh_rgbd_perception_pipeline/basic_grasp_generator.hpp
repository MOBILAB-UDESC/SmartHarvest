#ifndef SH_RGBD_PERCEPTION_PIPELINE__BASIC_GRASP_GENERATOR_HPP_
#define SH_RGBD_PERCEPTION_PIPELINE__BASIC_GRASP_GENERATOR_HPP_
 ...
 * @brief Grasp generator plugin that assigns fixed grasp orientations.
 *
 * This implementation applies predefined end-effector orientations to all
 * generated grasp poses.
 */
class BasicGraspGenerator: public sh_base_template::GraspGeneratorBase
{
public:
  /**
  ...
  /**
   * @brief Assign fixed grasp orientations to detected objects.
   *
   * Updates the provided pose list using predefined orientation values.
...
protected:
  ...
  std::vector<double> orientation_euler_;
};

}  // namespace sh_rgbd_perception_pipeline

#endif  // SH_RGBD_PERCEPTION_PIPELINE__BASIC_GRASP_GENERATOR_HPP_